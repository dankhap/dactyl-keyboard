...
(spit "parts/tests.scad"
      (write-scad wall-catter))

(def full-oled-box (cube oled-depth oled-width  15))
(def inner-oled-box (cube (- oled-depth 1) (- oled-width 1) 14.55))
...
(spit "parts/tests.scad"
      (write-scad left-wall-lower-hole))
...
(spit "parts/tests.scad"
      (write-scad bottom-oled-diff))
;; (let [oled-box-original (difference
;;                 (cube 6.45 40 15)
;;                 (union
;;                  (translate [-0.3 0.8 0] (cube 4.25 40 13.45))
;;                  (translate [10 0 0] (cube 20 25 10))
;;                  (translate [-0.3 35 0] (cube 6 40 13.45)))
;;                 )]
;;   (spit "parts/tests.scad"
;;         (write-scad oled-box)))

;; (let [oled-box (difference
;;                 (cube 40 40 15)
;;                 (union
;;                  (translate [-0.3 0 0] (cube 37 38 13.45))
;;                  (translate [10 0 0] (cube 20 25 10)))
;;                 )]
;;   (spit "parts/tests.scad"
;;         (write-scad oled-box)))
